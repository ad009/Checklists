...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSInteger countItems = [checklist.items count];
    
    if (countItems > 0) {
        NSInteger countUncheckedItems = [checklist countUncheckedItems];
        
        if (countUncheckedItems > 0) {
            cell.detailTextLabel.text = [NSString stringWithFormat:@"%d Remaining", countUncheckedItems];
        } else {
